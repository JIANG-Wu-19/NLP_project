...
在提交截止后，才看到upper上对于任务二也有使用BERT模型，所以尝试着调通了程序

也就是说这一个是基于upper的，只要在任务一后面套用BERT模型就可以解决关键词抽取问题

进阶完全体跑出来的分数还是比较可观的，能够达到0.41792，哭晕在厕所：）
...
2023年7月28日：完善了进阶项目，使其成为完全体，跑出来的分数也还不错